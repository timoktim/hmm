...
Stage03R WP8 is a pre-registered validation protocol. Hazard is locally usable, not broadly promoted; baseline-only and abstain rules remain conservative; HSMM lifecycle outputs remain interpretation-only.
...
```json
{
  ...
  "hazard_vs_hsmm": "reports/stage03r/hazard_vs_hsmm_report.json",
  "hazard_verdict": "reports/stage03r/multi_horizon_hazard_verdict.md",
  "hazard_readiness_version": "hazard_readiness_matrix_v1",
  "hazard_vs_hsmm_report_version": "hazard_vs_hsmm_report_v1",
  "hazard_verdict_present": "yes",
  "no_fetch": "yes"
}
```
...
```json
{
  ...
  "sample_support_by_horizon": {
    "1": {
      "slice_count": 23,
      "min_sample_count": 188,
      "total_sample_count": 116398,
      "total_positive_count": 21130
    },
    "3": {
      "slice_count": 23,
      "min_sample_count": 186,
      "total_sample_count": 116027,
      "total_positive_count": 49441
    },
    "5": {
      "slice_count": 23,
      "min_sample_count": 184,
      "total_sample_count": 115715,
      "total_positive_count": 68707
    },
    "10": {
      "slice_count": 23,
      "min_sample_count": 182,
      "total_sample_count": 115180,
      "total_positive_count": 94119
    },
    "20": {
      "slice_count": 23,
      "min_sample_count": 182,
      "total_sample_count": 114996,
      "total_positive_count": 109051
    }
  },
...
```json
{
  ...
  "legacy_ambiguous_comparison_field_present_in_input": "no",
  "unqualified_hsmm_lifecycle_status_in_protocol_summary": "no",
  "hsmm_lifecycle_probability_status_counts_diagnostic_only_by_horizon": {
    "1": {
      "ordinal_only": 311526,
      "raw_only": 169987,
...
```json
{
  ...
  "current_majority_status": "baseline_only_majority"
}
```
...
[
  ...
  "matched HSMM numeric p_exit artifact remains missing."
]
```
