    ...
    def _init_schema_with_connection(self, con: duckdb.DuckDBPyConnection) -> None:
            ...
            con.execute(
                ...
                CREATE TABLE IF NOT EXISTS hsmm_state_daily (
                  ...
                  p_exit_1d_status TEXT,
                  p_exit_3d_status TEXT,
                  p_exit_5d_status TEXT,
                  p_exit_10d_status TEXT,
                  p_exit_20d_status TEXT,
                  raw_p_exit_1d_status TEXT,
                  raw_p_exit_3d_status TEXT,
                  raw_p_exit_5d_status TEXT,
                  raw_p_exit_10d_status TEXT,
                  raw_p_exit_20d_status TEXT,
            ...
            for column_sql in [
                ...
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS duration_percentile_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS duration_tail_status TEXT",
                ...
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS p_exit_1d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS p_exit_3d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS p_exit_5d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS p_exit_10d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS p_exit_20d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS raw_p_exit_1d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS raw_p_exit_3d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS raw_p_exit_5d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS raw_p_exit_10d_status TEXT",
                "ALTER TABLE hsmm_state_daily ADD COLUMN IF NOT EXISTS raw_p_exit_20d_status TEXT",
            ...
            con.execute(
                ...
                CREATE TABLE IF NOT EXISTS hsmm_lifecycle_ui_daily (
                  ...
                  duration_tail_status_1d TEXT,
                  duration_tail_status_3d TEXT,
                  duration_tail_status_5d TEXT,
                  duration_tail_status_10d TEXT,
                  duration_tail_status_20d TEXT,
                  raw_p_exit_1d_status TEXT,
                  raw_p_exit_3d_status TEXT,
                  raw_p_exit_5d_status TEXT,
                  raw_p_exit_10d_status TEXT,
            ...
            for column_sql in [
                ...
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS duration_tail_status_1d TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS duration_tail_status_3d TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS duration_tail_status_5d TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS duration_tail_status_10d TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS duration_tail_status_20d TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS raw_p_exit_1d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS raw_p_exit_3d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS raw_p_exit_5d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS raw_p_exit_10d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS raw_p_exit_20d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS p_exit_1d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS p_exit_3d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS p_exit_5d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS p_exit_10d_status TEXT",
                "ALTER TABLE hsmm_lifecycle_ui_daily ADD COLUMN IF NOT EXISTS p_exit_20d_status TEXT",
            ...
            if constraints.empty or "profile_cutoff_date" not in constraint_text or "state_date_policy" not in constraint_text:
                ...
                lifecycle_cols = [
                    ...
                    "probability_status_10d", "probability_status_20d",
                    "duration_tail_status_1d", "duration_tail_status_3d", "duration_tail_status_5d",
                    "duration_tail_status_10d", "duration_tail_status_20d",
                    "raw_p_exit_1d_status", "raw_p_exit_3d_status", "raw_p_exit_5d_status",
                    "raw_p_exit_10d_status", "raw_p_exit_20d_status",
                    "p_exit_1d_status", "p_exit_3d_status", "p_exit_5d_status",
                    "p_exit_10d_status", "p_exit_20d_status",
                    "raw_score_used_1d", "raw_score_used_3d",
