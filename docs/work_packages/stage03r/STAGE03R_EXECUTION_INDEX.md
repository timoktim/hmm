...
| STAGE03R-WP1 | Exit Target Dataset v1 | active | stage03r/wp1-exit-target-dataset-v1 | causal, censored, purged exit target dataset |
...
| STAGE03R-WP4 | Age-Bucket Baseline | blocked_until_wp1 | stage03r/wp4-age-bucket-baseline | empirical baseline for hazard promotion comparison |
...
| STAGE03R-WP9 | Data Quality CI Invariants | blocked_until_wp1 | stage03r/wp9-data-quality-ci-invariants | persistent CI checks for ingestion and target leakage invariants |
