...
| STAGE03R-WP3 | Logistic Hazard Baseline | active | stage03r/wp3-logistic-hazard-baseline | lightweight per-horizon logistic hazard |
| STAGE03R-WP4 | Age-Bucket Baseline | blocked_until_wp3_or_parallel_instruction | stage03r/wp4-age-bucket-baseline | empirical baseline for hazard promotion comparison |
