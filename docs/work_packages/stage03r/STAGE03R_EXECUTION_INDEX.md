...
| STAGE03R-WP6 | Hazard Readiness Matrix | active | stage03r/wp6-hazard-readiness-matrix | state × horizon × age_bucket readiness status |
| STAGE03R-WP6.1 | Multi-Horizon Hazard Regeneration | active | stage03r/wp6.1-multi-horizon-hazard-regen | regenerate full-horizon hazard/calibration evidence and harden prediction sampling |
