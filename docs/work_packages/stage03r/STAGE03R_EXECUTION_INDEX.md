...
| STAGE03R-WP2 | Target Leakage and Purge Tests | active | stage03r/wp2-target-leakage-purge-tests | synthetic leakage/censoring/purge/embargo tests |
| STAGE03R-WP3 | Logistic Hazard Baseline | blocked_until_wp2 | stage03r/wp3-logistic-hazard-baseline | lightweight per-horizon logistic hazard |
| STAGE03R-WP4 | Age-Bucket Baseline | blocked_until_wp2 | stage03r/wp4-age-bucket-baseline | empirical baseline for hazard promotion comparison |
| STAGE03R-WP5 | Isotonic Calibration | blocked_until_wp3_wp4 | stage03r/wp5-isotonic-calibration | calibration on validation folds only |
...
| STAGE03R-WP9 | Data Quality CI Invariants | blocked_until_wp2 | stage03r/wp9-data-quality-ci-invariants | persistent CI checks for ingestion and target leakage invariants |
...
10. WP2 must pass before any hazard model training begins.
