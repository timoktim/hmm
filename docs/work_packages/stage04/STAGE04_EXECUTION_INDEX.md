...
8. No Stage04 package may create a decision layer, trading output, sizing, or recommendation output unless a later reviewed work package explicitly changes this rule.
